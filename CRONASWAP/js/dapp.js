...
const CONTRACT_ADDRESS = '0xF3cE1f923262E3DA33648D3A4c3eD53F47Ed540f'
const CRONA_SWAP_CONTRACT_ADDRESS = "0xadbd1231fb360047525BEdF962581F3eee7b49fe"
...
async function invest(contract, tokenContract, userAddress, accountBalance, tokenBalance, dashboardObserver) {
    ...
    const buttonStateObserver = {
        ...
        showErrorPopup('Deposit amount incorrect', 'Min deposit amount is 10 CRONA_SWAP', 5000)
        return
    }


    if (value.gt(tokenBalance)) {
        showErrorPopup('Not enough CRONA_SWAP', 'Not enough CRONA_SWAP to make an investment', 5000)
        return
    }

    if(accountBalance < TRANSACTION_FEE){
        showErrorPopup('Not enough CRONA_SWAP', 'Not enough CRONA_SWAP to process your transaction', 5000)
        return
    }
